...
%          Usage:  [tCount, tProb] = transmatrix(traj, 100, 10000, 2, 4), traj_len is a array
%         Author:  WANG Wei        (wwangat@gmail.com)
% ============================================================================
%

function  [tCount, tProb] = transCount(traj, traj_num, lagtime, nStates)
  ...
  if (length(find(sum(tCount, 1)==0)))~=0
     disp('need to remove disconnected states first');
  end
